...
$url = "http://api.pinboard.in/v1/posts/all?auth_token=".option('mirthe.import-pinboard.token')."&fromdt=".$startdatum."&todt=".$einddatum;
...
curl_setopt($ch, CURLOPT_USERAGENT, option('mirthe.import-pinboard.useragent'));		// set our useragent because del.icio.us likes it that way
